...
const NAV_GROUPS: NavGroup[] = [
   ...
   */
  {
    ...
    items: [
       ...
       *
       *  ⛔ صفحهٔ تازه‌ای ساخته نشد و نباید بشود: دو صفحه برای یک موضوع همان
       *  سردرگمی‌ای است که گامِ ۴ی ریمیک برداشت. این فقط همان صفحه است با
       *  فیلترِ آماده.
       *
       ...
       */
      { to: '/customers?app=shop', key: 'navShops', icon: Store },
