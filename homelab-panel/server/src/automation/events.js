...
export const KNOWN_EVENTS = Object.freeze({
  ...
  /*
   *  ربات‌های گامِ ۵. ⛔ هر یافتهٔ ربات یک رویداد است، نه یک پیامِ
   *  دست‌ساز: هشدار و اعلان از همان ماشینِ موجود می‌روند و ربات خودش
   *  ایمیل نمی‌زند.
   */
  'code.delivery_failed': 'کدی ساخته شد و به دستِ کسی نرسید — ورودیِ `code-rescue`',
  'bot.mail_not_configured': 'رباتِ ایمیلِ سرورِ حساب تنظیم نیست؛ ورودِ همهٔ برنامه‌ها بن‌بست است',
  'bot.codes_failing': 'نسبتِ کدهای نرفته از آستانه گذشت',
  'bot.subscription_expiring': 'اشتراکِ یک حساب رو به پایان است',
  'bot.no_subscription': 'حسابی هیچ اشتراکی ندارد',
  'bot.backup_late': 'پشتیبانِ یک پمپ دیر کرده',
  'bot.backup_never': 'از یک پمپ هیچ پشتیبانی نرسیده',
  'bot.live_stale': 'عکسِ زندهٔ یک پمپ کهنه شده',
});
