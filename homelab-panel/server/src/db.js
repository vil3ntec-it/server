...
/*
 *  ⚠️ بی این، هر نوشتنی که به قفل بخورد *همان لحظه* با SQLITE_BUSY
 *  می‌افتد — نه اینکه کمی صبر کند.
 *
 *  با WAL، خواندن و نوشتن همدیگر را نمی‌بندند، پس در کارِ عادی پیش
 *  نمی‌آید. ولی بکاپ (`VACUUM INTO`) و مهاجرت قفلِ کلِ فایل می‌گیرند، و
 *  دقیقاً همان لحظه اگر کسی کد بخواهد، درخواستش بی‌دلیل می‌افتاد.
 *
 *  پنج ثانیه از هر بکاپی بلندتر است و برای درخواستی که گیر کند هم آن‌قدر
 *  نیست که کاربر فکر کند سرور مرده.
 */
