...
data class FoundServer(
   ...
   *
   *  و کلید فقط بعد از ورود از داخلِ خانه صادر می‌شود. پس ترتیب این است:
   *
   *      بارِ اول (بی کلید)  →  آدرسِ خانه  →  ورود  →  کلید صادر می‌شود
   *      از آن به بعد        →  admin.<دامنه>، هر جای دنیا
   *
